...
CREATE TABLE address_book (    address_book_id int NOT NULL auto_increment,    customers_id int NOT NULL,    entry_gender char(1) NOT NULL,    entry_company varchar(32),    entry_firstname varchar(32) NOT NULL,    entry_lastname varchar(32) NOT NULL,    entry_street_address varchar(64) NOT NULL,    entry_suburb varchar(32),    entry_postcode varchar(10) NOT NULL,    entry_city varchar(32) NOT NULL,    entry_state varchar(32),    entry_country_id int DEFAULT '0' NOT NULL,    entry_zone_id int DEFAULT '0' NOT NULL,    PRIMARY KEY (address_book_id),    KEY idx_address_book_customers_id (customers_id) );
DROP TABLE IF EXISTS address_format;
CREATE TABLE address_format (   address_format_id int NOT NULL auto_increment,   address_format varchar(128) NOT NULL,   address_summary varchar(48) NOT NULL,   PRIMARY KEY (address_format_id) );
DROP TABLE IF EXISTS banners;
CREATE TABLE banners (   banners_id int NOT NULL auto_increment,   banners_title varchar(64) NOT NULL,   banners_url varchar(255) NOT NULL,   banners_image varchar(64) NOT NULL,   banners_group varchar(10) NOT NULL,   banners_html_text text,   expires_impressions int(7) DEFAULT '0',   expires_date datetime DEFAULT NULL,   date_scheduled datetime DEFAULT NULL,   date_added datetime NOT NULL,   date_status_change datetime DEFAULT NULL,   status int(1) DEFAULT '1' NOT NULL,   PRIMARY KEY  (banners_id) );
DROP TABLE IF EXISTS banners_history;
CREATE TABLE banners_history (   banners_history_id int NOT NULL auto_increment,   banners_id int NOT NULL,   banners_shown int(5) NOT NULL DEFAULT '0',   banners_clicked int(5) NOT NULL DEFAULT '0',   banners_history_date datetime NOT NULL,   PRIMARY KEY  (banners_history_id) );
...
CREATE TABLE categories_description (    categories_id int DEFAULT '0' NOT NULL,    language_id int DEFAULT '1' NOT NULL,    categories_name varchar(32) NOT NULL,    PRIMARY KEY (categories_id, language_id),    KEY idx_categories_name (categories_name) );
...
CREATE TABLE configuration_group (   configuration_group_id int NOT NULL auto_increment,   configuration_group_title varchar(64) NOT NULL,   configuration_group_desc varchar(255) NOT NULL,   sort_order int(5) NULL,   visible int(1) DEFAULT '1' NULL,   PRIMARY KEY (configuration_group_id) );
DROP TABLE IF EXISTS counter;
CREATE TABLE counter (   startdate char(8),   counter int(12) );
DROP TABLE IF EXISTS counter_history;
CREATE TABLE counter_history (   month char(8),   counter int(12) );
DROP TABLE IF EXISTS countries;
CREATE TABLE countries (   countries_id int NOT NULL auto_increment,   countries_name varchar(64) NOT NULL,   countries_iso_code_2 char(2) NOT NULL,   countries_iso_code_3 char(3) NOT NULL,   address_format_id int NOT NULL,   PRIMARY KEY (countries_id),   KEY IDX_COUNTRIES_NAME (countries_name) );
DROP TABLE IF EXISTS currencies;
CREATE TABLE currencies (   currencies_id int NOT NULL auto_increment,   title varchar(32) NOT NULL,   code char(3) NOT NULL,   symbol_left varchar(12),   symbol_right varchar(12),   decimal_point char(1),   thousands_point char(1),   decimal_places char(1),   value float(13,8),   last_updated datetime NULL,   PRIMARY KEY (currencies_id) );
DROP TABLE IF EXISTS customers;
CREATE TABLE customers (    customers_id int NOT NULL auto_increment,    customers_gender char(1) NOT NULL,    customers_firstname varchar(32) NOT NULL,    customers_lastname varchar(32) NOT NULL,    customers_dob datetime DEFAULT '0000-00-00 00:00:00' NOT NULL,    customers_email_address varchar(96) NOT NULL,    customers_default_address_id int NOT NULL,    customers_telephone varchar(32) NOT NULL,    customers_fax varchar(32),    customers_password varchar(40) NOT NULL,    customers_newsletter char(1),    PRIMARY KEY (customers_id) );
...
CREATE TABLE customers_basket_attrs (   customers_basket_attributes_id int NOT NULL auto_increment,   customers_id int NOT NULL,   products_id tinytext NOT NULL,   products_options_id int NOT NULL,   products_options_value_id int NOT NULL,   PRIMARY KEY (customers_basket_attributes_id) );
DROP TABLE IF EXISTS customers_info;
CREATE TABLE customers_info (   customers_info_id int NOT NULL,   customers_info_date_last_logon datetime,   customers_info_number_of_logon int(5),   customers_info_date_created datetime,   customers_info_date_modified datetime,   global_product_notifications int(1) DEFAULT '0',   PRIMARY KEY (customers_info_id) );
DROP TABLE IF EXISTS languages;
CREATE TABLE languages (   languages_id int NOT NULL auto_increment,   name varchar(32)  NOT NULL,   code char(2) NOT NULL,   image varchar(64),   directory varchar(32),   sort_order int(3),   PRIMARY KEY (languages_id),   KEY IDX_LANGUAGES_NAME (name) );
DROP TABLE IF EXISTS manufacturers;
CREATE TABLE manufacturers (   manufacturers_id int NOT NULL auto_increment,   manufacturers_name varchar(32) NOT NULL,   manufacturers_image varchar(64),   date_added datetime NULL,   last_modified datetime NULL,   PRIMARY KEY (manufacturers_id),   KEY IDX_MANUFACTURERS_NAME (manufacturers_name) );
DROP TABLE IF EXISTS manufacturers_info;
CREATE TABLE manufacturers_info (   manufacturers_id int NOT NULL,   languages_id int NOT NULL,   manufacturers_url varchar(255) NOT NULL,   url_clicked int(5) NOT NULL default '0',   date_last_click datetime NULL,   PRIMARY KEY (manufacturers_id, languages_id) );
DROP TABLE IF EXISTS newsletters;
CREATE TABLE newsletters (   newsletters_id int NOT NULL auto_increment,   title varchar(255) NOT NULL,   content text NOT NULL,   module varchar(255) NOT NULL,   date_added datetime NOT NULL,   date_sent datetime,   status int(1),   locked int(1) DEFAULT '0',   PRIMARY KEY (newsletters_id) );
DROP TABLE IF EXISTS orders;
CREATE TABLE orders (   orders_id int NOT NULL auto_increment,   customers_id int NOT NULL,   customers_name varchar(64) NOT NULL,   customers_company varchar(32),   customers_street_address varchar(64) NOT NULL,   customers_suburb varchar(32),   customers_city varchar(32) NOT NULL,   customers_postcode varchar(10) NOT NULL,   customers_state varchar(32),   customers_country varchar(32) NOT NULL,   customers_telephone varchar(32) NOT NULL,   customers_email_address varchar(96) NOT NULL,   customers_address_format_id int(5) NOT NULL,   delivery_name varchar(64) NOT NULL,   delivery_company varchar(32),   delivery_street_address varchar(64) NOT NULL,   delivery_suburb varchar(32),   delivery_city varchar(32) NOT NULL,   delivery_postcode varchar(10) NOT NULL,   delivery_state varchar(32),   delivery_country varchar(32) NOT NULL,   delivery_address_format_id int(5) NOT NULL,   billing_name varchar(64) NOT NULL,   billing_company varchar(32),   billing_street_address varchar(64) NOT NULL,   billing_suburb varchar(32),   billing_city varchar(32) NOT NULL,   billing_postcode varchar(10) NOT NULL,   billing_state varchar(32),   billing_country varchar(32) NOT NULL,   billing_address_format_id int(5) NOT NULL,   payment_method varchar(32) NOT NULL,   cc_type varchar(20),   cc_owner varchar(64),   cc_number varchar(32),   cc_expires varchar(4),   last_modified datetime,   date_purchased datetime,   orders_status int(5) NOT NULL,   orders_date_finished datetime,   currency char(3),   currency_value decimal(14,6),   PRIMARY KEY (orders_id) );
DROP TABLE IF EXISTS orders_products;
CREATE TABLE orders_products (   orders_products_id int NOT NULL auto_increment,   orders_id int NOT NULL,   products_id int NOT NULL,   products_model varchar(12),   products_name varchar(64) NOT NULL,   products_price decimal(15,4) NOT NULL,   final_price decimal(15,4) NOT NULL,   products_tax decimal(7,4) NOT NULL,   products_quantity int(2) NOT NULL,   PRIMARY KEY (orders_products_id) );
DROP TABLE IF EXISTS orders_status;
CREATE TABLE orders_status (    orders_status_id int DEFAULT '0' NOT NULL,    language_id int DEFAULT '1' NOT NULL,    orders_status_name varchar(32) NOT NULL,    PRIMARY KEY (orders_status_id, language_id),    KEY idx_orders_status_name (orders_status_name) );
DROP TABLE IF EXISTS orders_status_history;
CREATE TABLE orders_status_history (    orders_status_history_id int NOT NULL auto_increment,    orders_id int NOT NULL,    orders_status_id int(5) NOT NULL,    date_added datetime NOT NULL,    customer_notified int(1) DEFAULT '0',    comments text,    PRIMARY KEY (orders_status_history_id) );
DROP TABLE IF EXISTS orders_products_attributes;
CREATE TABLE orders_products_attributes (   orders_products_attributes_id int NOT NULL auto_increment,   orders_id int NOT NULL,   orders_products_id int NOT NULL,   products_options varchar(32) NOT NULL,   products_options_values varchar(32) NOT NULL,   options_values_price decimal(15,4) NOT NULL,   price_prefix char(1) NOT NULL,   PRIMARY KEY (orders_products_attributes_id) );
DROP TABLE IF EXISTS orders_products_download;
CREATE TABLE orders_products_download (   orders_products_download_id int NOT NULL auto_increment,   orders_id int NOT NULL default '0',   orders_products_id int NOT NULL default '0',   orders_products_filename varchar(255) NOT NULL default '',   download_maxdays int(2) NOT NULL default '0',   download_count int(2) NOT NULL default '0',   PRIMARY KEY  (orders_products_download_id) );
DROP TABLE IF EXISTS orders_total;
CREATE TABLE orders_total (   orders_total_id int unsigned NOT NULL auto_increment,   orders_id int NOT NULL,   title varchar(255) NOT NULL,   text varchar(255) NOT NULL,   value decimal(15,4) NOT NULL,   class varchar(32) NOT NULL,   sort_order int NOT NULL,   PRIMARY KEY (orders_total_id),   KEY idx_orders_total_orders_id (orders_id) );
DROP TABLE IF EXISTS products;
CREATE TABLE products (   products_id int NOT NULL auto_increment,   products_quantity int(4) NOT NULL,   products_model varchar(12),   products_image varchar(64),   products_price decimal(15,4) NOT NULL,   products_date_added datetime NOT NULL,   products_last_modified datetime,   products_date_available datetime,   products_weight decimal(5,2) NOT NULL,   products_status tinyint(1) NOT NULL,   products_tax_class_id int NOT NULL,   manufacturers_id int NULL,   products_ordered int NOT NULL default '0',   PRIMARY KEY (products_id),   KEY idx_products_date_added (products_date_added) );
DROP TABLE IF EXISTS products_attributes;
CREATE TABLE products_attributes (   products_attributes_id int NOT NULL auto_increment,   products_id int NOT NULL,   options_id int NOT NULL,   options_values_id int NOT NULL,   options_values_price decimal(15,4) NOT NULL,   price_prefix char(1) NOT NULL,   PRIMARY KEY (products_attributes_id) );
DROP TABLE IF EXISTS products_attrs_download;
CREATE TABLE products_attrs_download (   products_attributes_id int NOT NULL,   products_attributes_filename varchar(255) NOT NULL default '',   products_attributes_maxdays int(2) default '0',   products_attributes_maxcount int(2) default '0',   PRIMARY KEY  (products_attributes_id) );
DROP TABLE IF EXISTS products_description;
CREATE TABLE products_description (   products_id int NOT NULL auto_increment,   language_id int NOT NULL default '1',   products_name varchar(64) NOT NULL default '',   products_description text,   products_url varchar(255) default NULL,   products_viewed int(5) default '0',   PRIMARY KEY  (products_id,language_id),   KEY products_name (products_name) );
DROP TABLE IF EXISTS products_notifications;
CREATE TABLE products_notifications (   products_id int NOT NULL,   customers_id int NOT NULL,   date_added datetime NOT NULL,   PRIMARY KEY (products_id, customers_id) );
DROP TABLE IF EXISTS products_options;
CREATE TABLE products_options (   products_options_id int NOT NULL default '0',   language_id int NOT NULL default '1',   products_options_name varchar(32) NOT NULL default '',   PRIMARY KEY  (products_options_id,language_id) );
DROP TABLE IF EXISTS products_options_values;
CREATE TABLE products_options_values (   products_options_values_id int NOT NULL default '0',   language_id int NOT NULL default '1',   products_options_values_name varchar(64) NOT NULL default '',   PRIMARY KEY  (products_options_values_id,language_id) );
DROP TABLE IF EXISTS prod_opt_vals_to_prod_opt;
CREATE TABLE prod_opt_vals_to_prod_opt (   prod_opt_vals_to_prod_opt_id int NOT NULL auto_increment,   products_options_id int NOT NULL,   products_options_values_id int NOT NULL,   PRIMARY KEY (prod_opt_vals_to_prod_opt_id) );
DROP TABLE IF EXISTS products_to_categories;
CREATE TABLE products_to_categories (   products_id int NOT NULL,   categories_id int NOT NULL,   PRIMARY KEY (products_id,categories_id) );
DROP TABLE IF EXISTS reviews;
CREATE TABLE reviews (   reviews_id int NOT NULL auto_increment,   products_id int NOT NULL,   customers_id int,   customers_name varchar(64) NOT NULL,   reviews_rating int(1),   date_added datetime,   last_modified datetime,   reviews_read int(5) NOT NULL default '0',   PRIMARY KEY (reviews_id) );
DROP TABLE IF EXISTS reviews_description;
CREATE TABLE reviews_description (   reviews_id int NOT NULL,   languages_id int NOT NULL,   reviews_text text NOT NULL,   PRIMARY KEY (reviews_id, languages_id) );
DROP TABLE IF EXISTS sessions;
CREATE TABLE sessions (   sesskey varchar(32) NOT NULL,   expiry int(11) unsigned NOT NULL,   value text NOT NULL,   PRIMARY KEY (sesskey) );
DROP TABLE IF EXISTS specials;
CREATE TABLE specials (   specials_id int NOT NULL auto_increment,   products_id int NOT NULL,   specials_new_products_price decimal(15,4) NOT NULL,   specials_date_added datetime,   specials_last_modified datetime,   expires_date datetime,   date_status_change datetime,   status int(1) NOT NULL DEFAULT '1',   PRIMARY KEY (specials_id) );
DROP TABLE IF EXISTS tax_class;
CREATE TABLE tax_class (   tax_class_id int NOT NULL auto_increment,   tax_class_title varchar(32) NOT NULL,   tax_class_description varchar(255) NOT NULL,   last_modified datetime NULL,   date_added datetime NOT NULL,   PRIMARY KEY (tax_class_id) );
DROP TABLE IF EXISTS tax_rates;
CREATE TABLE tax_rates (   tax_rates_id int NOT NULL auto_increment,   tax_zone_id int NOT NULL,   tax_class_id int NOT NULL,   tax_priority int(5) DEFAULT 1,   tax_rate decimal(7,4) NOT NULL,   tax_description varchar(255) NOT NULL,   last_modified datetime NULL,   date_added datetime NOT NULL,   PRIMARY KEY (tax_rates_id) );
DROP TABLE IF EXISTS geo_zones;
CREATE TABLE geo_zones (   geo_zone_id int NOT NULL auto_increment,   geo_zone_name varchar(32) NOT NULL,   geo_zone_description varchar(255) NOT NULL,   last_modified datetime NULL,   date_added datetime NOT NULL,   PRIMARY KEY (geo_zone_id) );
DROP TABLE IF EXISTS whos_online;
CREATE TABLE whos_online (   customer_id int,   full_name varchar(64) NOT NULL,   session_id varchar(128) NOT NULL,   ip_address varchar(15) NOT NULL,   time_entry varchar(14) NOT NULL,   time_last_click varchar(14) NOT NULL,   last_page_url varchar(64) NOT NULL );
DROP TABLE IF EXISTS zones;
CREATE TABLE zones (   zone_id int NOT NULL auto_increment,   zone_country_id int NOT NULL,   zone_code varchar(32) NOT NULL,   zone_name varchar(32) NOT NULL,   PRIMARY KEY (zone_id) );
DROP TABLE IF EXISTS zones_to_geo_zones;
CREATE TABLE zones_to_geo_zones (    association_id int NOT NULL auto_increment,    zone_country_id int NOT NULL,    zone_id int NULL,    geo_zone_id int NULL,    last_modified datetime NULL,    date_added datetime NOT NULL,    PRIMARY KEY (association_id) );
...
CREATE TABLE ipn_history (    ipn_history_id int NOT NULL auto_increment,    module_code varchar(32) NOT NULL,    gateway_transaction_id varchar(128),    gateway_result varchar(128),    gateway_full_response text,    order_id int,    konakart_result_id int,    konakart_result_description varchar(255),    date_added datetime,    PRIMARY KEY (ipn_history_id) );
...
CREATE TABLE promotion (    promotion_id int NOT NULL auto_increment,    order_total_code varchar(32) NOT NULL,    description varchar(128),    name varchar(64),    active int(1) NOT NULL DEFAULT '0',    cumulative int(1) NOT NULL DEFAULT '0',    requires_coupon int(1) NOT NULL DEFAULT '0',    start_date datetime,    end_date datetime,    manufacturer_rule int,    product_rule int,    customer_rule int,    category_rule int,    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    custom4 varchar(128),    custom5 varchar(128),    custom6 varchar(128),    custom7 varchar(128),    custom8 varchar(128),    custom9 varchar(128),    custom10 varchar(128),    date_added datetime NOT NULL,    last_modified datetime,    PRIMARY KEY (promotion_id) );
DROP TABLE IF EXISTS promotion_to_manufacturer;
CREATE TABLE promotion_to_manufacturer (   promotion_id int NOT NULL,   manufacturers_id int NOT NULL,   PRIMARY KEY (promotion_id,manufacturers_id) );
DROP TABLE IF EXISTS promotion_to_product;
CREATE TABLE promotion_to_product (   promotion_id int NOT NULL,   products_id int NOT NULL,   products_options_id int NOT NULL DEFAULT '0',   products_options_values_id int NOT NULL DEFAULT '0',   PRIMARY KEY (promotion_id,products_id,products_options_id,products_options_values_id) );
DROP TABLE IF EXISTS promotion_to_category;
CREATE TABLE promotion_to_category (   promotion_id int NOT NULL,   categories_id int NOT NULL,   PRIMARY KEY (promotion_id,categories_id) );
DROP TABLE IF EXISTS promotion_to_customer;
CREATE TABLE promotion_to_customer (   promotion_id int NOT NULL,   customers_id int NOT NULL,   max_use int NOT NULL DEFAULT '-1',   times_used int NOT NULL DEFAULT '0',   custom1 varchar(128),   custom2 varchar(128),   PRIMARY KEY (promotion_id,customers_id) );
DROP TABLE IF EXISTS coupon;
CREATE TABLE coupon (    coupon_id int NOT NULL auto_increment,    coupon_code varchar(64) NOT NULL,    name varchar(64),    description varchar(128),    max_use int NOT NULL DEFAULT '1',    times_used int NOT NULL DEFAULT '0',    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    custom4 varchar(128),    custom5 varchar(128),    date_added datetime NOT NULL,    last_modified datetime,    PRIMARY KEY (coupon_id) );
DROP TABLE IF EXISTS promotion_to_coupon;
CREATE TABLE promotion_to_coupon (   promotion_id int NOT NULL,   coupon_id int NOT NULL,   PRIMARY KEY (promotion_id,coupon_id) );
ALTER TABLE orders ADD COLUMN promotion_ids varchar(64);
ALTER TABLE orders ADD COLUMN coupon_ids varchar(64);
DROP TABLE IF EXISTS utility;
CREATE TABLE utility ( 	id int NOT NULL, 	PRIMARY KEY (id) );
DELETE FROM utility;
...
CREATE TABLE products_to_products (   products_to_products_id int NOT NULL auto_increment,   id_from int NOT NULL,   id_to int NOT NULL,   relation_type int DEFAULT '0' NOT NULL,   custom1 varchar(128),   custom2 varchar(128),   PRIMARY KEY (products_to_products_id) );
...
CREATE TABLE products_quantity (    products_id int NOT NULL,    products_options varchar(128) NOT NULL,    products_quantity int NOT NULL,    products_sku varchar(255),    PRIMARY KEY (products_id, products_options) );
...
CREATE TABLE orders_returns (    orders_returns_id int NOT NULL auto_increment,    orders_id int NOT NULL,    rma_code varchar(128),    return_reason text,    date_added datetime,    last_modified datetime,    PRIMARY KEY (orders_returns_id) );
DROP TABLE IF EXISTS returns_to_ord_prods;
CREATE TABLE returns_to_ord_prods (    orders_returns_id int NOT NULL,    orders_products_id int NOT NULL,    quantity int NOT NULL,    date_added datetime,    PRIMARY KEY (orders_returns_id, orders_products_id) );
...
CREATE TABLE kk_audit (    audit_id int NOT NULL auto_increment,    customers_id int NOT NULL,    audit_action int NOT NULL,    api_method_name varchar(128) NOT NULL,    object_id int,    object_to_string text,    date_added datetime NOT NULL,    PRIMARY KEY (audit_id) );
...
CREATE TABLE kk_role (    role_id int NOT NULL auto_increment,    name varchar(128) NOT NULL,    description varchar(255),    date_added datetime,    last_modified datetime,    PRIMARY KEY (role_id) );
DROP TABLE IF EXISTS kk_customers_to_role;
CREATE TABLE kk_customers_to_role (    ctor_id int NOT NULL auto_increment,    role_id int DEFAULT '0' NOT NULL,    customers_id int DEFAULT '0' NOT NULL,    store_id varchar(64),    date_added datetime,    PRIMARY KEY (ctor_id) );
DROP TABLE IF EXISTS kk_panel;
CREATE TABLE kk_panel (    panel_id int NOT NULL auto_increment,    code varchar(128) NOT NULL,    description varchar(255),    date_added datetime,    last_modified datetime,    PRIMARY KEY (panel_id) );
DROP TABLE IF EXISTS kk_role_to_panel;
CREATE TABLE kk_role_to_panel (    role_id int DEFAULT '0' NOT NULL,    panel_id int DEFAULT '0' NOT NULL,    can_edit int DEFAULT '0',    can_insert int DEFAULT '0',    can_delete int DEFAULT '0',    custom1 int DEFAULT '0',    custom1_desc varchar(128),    custom2 int DEFAULT '0',    custom2_desc varchar(128),    custom3 int DEFAULT '0',    custom3_desc varchar(128),    custom4 int DEFAULT '0',    custom4_desc varchar(128),    custom5 int DEFAULT '0',    custom5_desc varchar(128),    date_added datetime,    last_modified datetime,    PRIMARY KEY (role_id, panel_id) );
...
CREATE TABLE kk_digital_download (   products_id int DEFAULT '0' NOT NULL,   customers_id int DEFAULT '0' NOT NULL,   max_downloads int DEFAULT '-1',   times_downloaded int DEFAULT '0',   expiration_date datetime,   date_added datetime,   last_modified datetime,   PRIMARY KEY (products_id, customers_id) );
...
DROP TABLE IF EXISTS counter;
CREATE TABLE counter (   counter_id int NOT NULL auto_increment,   startdate char(8),   counter int(12),   PRIMARY KEY (counter_id) );
...
CREATE TABLE kk_api_call (    api_call_id int NOT NULL auto_increment,    name varchar(128) NOT NULL,    description varchar(255),    date_added datetime,    last_modified datetime,    PRIMARY KEY (api_call_id) );
DROP TABLE IF EXISTS kk_role_to_api_call;
CREATE TABLE kk_role_to_api_call (    role_id int DEFAULT '0' NOT NULL,    api_call_id int DEFAULT '0' NOT NULL,    date_added datetime,    PRIMARY KEY (role_id, api_call_id) );
...
CREATE TABLE kk_customer_group (    customer_group_id int DEFAULT '0' NOT NULL,    language_id int DEFAULT '1' NOT NULL,    name varchar(64) NOT NULL,    description varchar(128),    date_added datetime,    last_modified datetime,    PRIMARY KEY (customer_group_id, language_id) );
...
CREATE TABLE promotion_to_cust_group (   promotion_id int NOT NULL,   customers_group_id int NOT NULL,   PRIMARY KEY (promotion_id,customers_group_id) );
...
CREATE TABLE kk_tag_group (    tag_group_id int DEFAULT '0' NOT NULL,    language_id int DEFAULT '1' NOT NULL,    name varchar(128) NOT NULL,    description varchar(255),    PRIMARY KEY (tag_group_id, language_id) );
DROP TABLE IF EXISTS kk_tag;
CREATE TABLE kk_tag (    tag_id int DEFAULT '0' NOT NULL,    language_id int DEFAULT '1' NOT NULL,    name varchar(128) NOT NULL,    sort_order int default '0',    PRIMARY KEY (tag_id, language_id) );
DROP TABLE IF EXISTS kk_category_to_tag_group;
CREATE TABLE kk_category_to_tag_group (   categories_id int NOT NULL,   tag_group_id int NOT NULL,   PRIMARY KEY (categories_id,tag_group_id) );
DROP TABLE IF EXISTS kk_tag_group_to_tag;
CREATE TABLE kk_tag_group_to_tag (   tag_group_id int NOT NULL,   tag_id int NOT NULL,   PRIMARY KEY (tag_group_id,tag_id) );
DROP TABLE IF EXISTS kk_tag_to_product;
CREATE TABLE kk_tag_to_product (   tag_id int NOT NULL,   products_id int NOT NULL,   date_added datetime NOT NULL,   PRIMARY KEY (tag_id,products_id) );
DELETE FROM kk_tag;
...
CREATE TABLE kk_store (   store_id varchar(64) NOT NULL,   store_name varchar(64) NOT NULL,   store_desc varchar(128) NOT NULL,   store_enabled int(1) NOT NULL,   store_under_maint int(1) NOT NULL,   store_deleted int(1) NOT NULL,   store_template int(1) NOT NULL,   store_admin_email varchar(96),   store_css_filename varchar(128),   store_logo_filename varchar(128),   store_url varchar(128),   store_home varchar(64),   store_max_products int NOT NULL DEFAULT '-1',   custom1 varchar(128),   custom2 varchar(128),   custom3 varchar(128),   custom4 varchar(128),   custom5 varchar(128),   date_added datetime,   last_updated datetime,   PRIMARY KEY (store_id) );
...
CREATE TABLE kk_wishlist (   kk_wishlist_id int NOT NULL auto_increment,   store_id varchar(64),   customers_id int NOT NULL,   name varchar(128),   description varchar(255),   public_or_private int NOT NULL,   date_added datetime NOT NULL,   customers_firstname varchar(32),   customers_lastname varchar(32),   customers_dob datetime,   customers_city varchar(32),   customers_state varchar(32),   custom1 varchar(128),   custom2 varchar(128),   custom3 varchar(128),   custom4 varchar(128),   custom5 varchar(128),   PRIMARY KEY (kk_wishlist_id) );
DROP TABLE IF EXISTS kk_wishlist_item;
CREATE TABLE kk_wishlist_item (   kk_wishlist_item_id int NOT NULL auto_increment,   store_id varchar(64),   kk_wishlist_id int NOT NULL,   products_id varchar(255) NOT NULL,   priority int,   date_added datetime NOT NULL,   custom1 varchar(128),   custom2 varchar(128),   custom3 varchar(128),   custom4 varchar(128),   custom5 varchar(128),   PRIMARY KEY (kk_wishlist_item_id) );
...
CREATE TABLE kk_cookie (   customer_uuid varchar(128) NOT NULL,   attribute_id varchar(64) NOT NULL,   attribute_value varchar(256),   date_added datetime NOT NULL,   last_read datetime,   last_modified datetime,   PRIMARY KEY (customer_uuid, attribute_id) );
...
DROP TABLE IF EXISTS sessions;
CREATE TABLE sessions (   sesskey varchar(32) NOT NULL,   expiry int(11) unsigned NOT NULL,   customer_id int NULL,   value varchar(256) NULL,   store_id varchar(64) NULL,   custom1 varchar(128) NULL,   custom2 varchar(128) NULL,   custom3 varchar(128) NULL,   custom4 varchar(128) NULL,   custom5 varchar(128) NULL,   PRIMARY KEY (sesskey) );
ALTER TABLE sessions ADD KEY idx_store_id (store_id);
...
CREATE TABLE kk_product_to_stores (   store_id varchar(64) NOT NULL,   products_id int NOT NULL,   price_id int NOT NULL DEFAULT '-1',   PRIMARY KEY (store_id ,products_id) );
...
CREATE TABLE kk_customer_tag (    kk_customer_tag_id int NOT NULL auto_increment,    store_id varchar(64),    name varchar(64) NOT NULL,    description varchar(255) NOT NULL,    validation varchar(128),    tag_type integer DEFAULT '0' NOT NULL,    max_ints integer DEFAULT '1',    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    custom4 varchar(128),    custom5 varchar(128),    date_added datetime NOT NULL,    PRIMARY KEY (kk_customer_tag_id),    KEY idx_name_kk_customer_tag (name),    KEY idx_store_id_kk_customer_tag (store_id)    );
DROP TABLE IF EXISTS kk_customers_to_tag;
CREATE TABLE kk_customers_to_tag (    kk_customer_tag_id int DEFAULT '0' NOT NULL,    customers_id int DEFAULT '0' NOT NULL,    store_id varchar(64),    name varchar(64) NOT NULL,    tag_value varchar(255),    date_added datetime NOT NULL,    PRIMARY KEY (kk_customer_tag_id, customers_id),    KEY idx_name_kk_customers_to_tag (name),    KEY idx_stor_kk_customers_to_tag (store_id) );
...
CREATE TABLE kk_expression (    kk_expression_id int NOT NULL auto_increment,    store_id varchar(64),    name varchar(64) NOT NULL,    description varchar(255),    num_variables integer DEFAULT '0' NOT NULL,    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    date_added datetime NOT NULL,    PRIMARY KEY (kk_expression_id),    KEY idx_name_kk_expression (name),    KEY idx_store_id_kk_expression (store_id)    );
DROP TABLE IF EXISTS kk_expression_variable;
CREATE TABLE kk_expression_variable (    kk_expression_variable_id int NOT NULL auto_increment,    kk_customer_tag_id int DEFAULT '0' NOT NULL,    kk_expression_id int DEFAULT '0' NOT NULL,    store_id varchar(64),    tag_type integer DEFAULT '0' NOT NULL,    tag_value varchar(255) NOT NULL,    operator integer DEFAULT '0' NOT NULL,    tag_order integer DEFAULT '0' NOT NULL,    tag_and_or integer DEFAULT '0' NOT NULL,    group_order integer DEFAULT '0' NOT NULL,    group_and_or integer DEFAULT '0' NOT NULL,    date_added datetime NOT NULL,    PRIMARY KEY (kk_expression_variable_id),    KEY idx_exp_kk_express_to_tag (kk_expression_id),    KEY idx_stor_kk_express_to_tag (store_id)    );
...
CREATE TABLE kk_promotion_to_expression (   promotion_id int NOT NULL,   kk_expression_id int NOT NULL,   store_id varchar(64),   PRIMARY KEY (promotion_id,kk_expression_id),   KEY idx_store_id (store_id) );
...
CREATE TABLE kk_product_prices (   store_id varchar(64),   catalog_id varchar(32) NOT NULL,   products_id int NOT NULL,   products_attributes_id int NOT NULL,   products_price_0 decimal(15,4),   products_price_1 decimal(15,4),   products_price_2 decimal(15,4),   products_price_3 decimal(15,4),   PRIMARY KEY (catalog_id,products_id, products_attributes_id) );
...
CREATE TABLE kk_digital_download_1 (   kk_digital_download_id int NOT NULL auto_increment,   store_id varchar(64),   products_id int DEFAULT '0' NOT NULL,   customers_id int DEFAULT '0' NOT NULL,   products_file_path varchar(255),   max_downloads int DEFAULT '-1',   times_downloaded int DEFAULT '0',   expiration_date datetime,   date_added datetime,   last_modified datetime,   PRIMARY KEY (kk_digital_download_id),   KEY i_prodid_kk_digdown_1 (products_id),   KEY i_custid_kk_digdown_1 (customers_id),   KEY i_storid_kk_digdown_1 (store_id) );
...
CREATE TABLE kk_secret_key (    kk_secret_key_id int NOT NULL auto_increment,    secret_key varchar(255) NOT NULL,    orders_id integer NOT NULL,    date_added datetime NOT NULL,    PRIMARY KEY (kk_secret_key_id),    KEY idx_secret_key_kk_secret_key (secret_key)    );
...
CREATE TABLE kk_reward_points (   kk_reward_points_id int NOT NULL auto_increment,   store_id varchar(64),   code varchar(64),   description varchar(256),   customers_id int DEFAULT '0' NOT NULL,   initial_points int DEFAULT '0' NOT NULL,   remaining_points int DEFAULT '0' NOT NULL,   expired int DEFAULT '0' NOT NULL,   tx_type int DEFAULT '0' NOT NULL,   date_added datetime NOT NULL,   PRIMARY KEY (kk_reward_points_id),   KEY i_custid_kk_reward_pts (customers_id),   KEY i_storid_kk_reward_pts (store_id) );
DROP TABLE IF EXISTS kk_reserved_points;
CREATE TABLE kk_reserved_points (   kk_reserved_points_id int NOT NULL auto_increment,   store_id varchar(64),   customers_id int DEFAULT '0' NOT NULL,   reward_points_id int DEFAULT '0' NOT NULL,   reservation_id int DEFAULT '0' NOT NULL,   reserved_points int DEFAULT '0' NOT NULL,   date_added datetime NOT NULL,   PRIMARY KEY (kk_reserved_points_id),   KEY i_custid_kk_reserved_pts (reservation_id),   KEY i_storid_kk_reserved_pts (store_id) );
...
CREATE TABLE kk_payment_schedule (   kk_payment_schedule_id int NOT NULL auto_increment,   store_id varchar(64),   name varchar(64),   description varchar(256),   length int DEFAULT '0' NOT NULL,   unit int DEFAULT '0' NOT NULL,   day_of_month int DEFAULT '0' NOT NULL,   occurrences int DEFAULT '0' NOT NULL,   trial_occurrences int DEFAULT '0' NOT NULL,   custom1 varchar(128),   custom2 varchar(128),   custom3 varchar(128),   custom4 varchar(128),   custom5 varchar(128),   date_added datetime NOT NULL,   PRIMARY KEY (kk_payment_schedule_id),   KEY i_storid_kk_pay_sched (store_id) );
DROP TABLE IF EXISTS kk_subscription;
CREATE TABLE kk_subscription (   kk_subscription_id int NOT NULL auto_increment,   store_id varchar(64),   orders_id int DEFAULT '0' NOT NULL,   orders_number varchar(128),   customers_id int DEFAULT '0' NOT NULL,   products_id int DEFAULT '0' NOT NULL,   payment_schedule_id int DEFAULT '0' NOT NULL,   products_sku varchar(255),   subscription_code varchar(128),   start_date datetime,   amount decimal(15,4) NOT NULL,   trial_amount decimal(15,4),   active int DEFAULT '0' NOT NULL,   problem int DEFAULT '0' NOT NULL,   problem_description varchar(255),   last_billing_date datetime,   next_billing_date datetime,   custom1 varchar(128),   custom2 varchar(128),   custom3 varchar(128),   custom4 varchar(128),   custom5 varchar(128),   date_added datetime NOT NULL,   last_modified datetime,   PRIMARY KEY (kk_subscription_id),   KEY i_storid_kk_subscription (store_id) );
...
DROP TABLE IF EXISTS kk_product_prices;
CREATE TABLE kk_product_prices (   store_id varchar(64),   catalog_id varchar(32) NOT NULL,   products_id int NOT NULL,   products_attributes_id int NOT NULL,   tier_price_id int NOT NULL DEFAULT 0,   products_price_0 decimal(15,4),   products_price_1 decimal(15,4),   products_price_2 decimal(15,4),   products_price_3 decimal(15,4),   PRIMARY KEY (catalog_id, products_id, products_attributes_id, tier_price_id) );
DROP TABLE IF EXISTS kk_tier_price;
CREATE TABLE kk_tier_price (   kk_tier_price_id int NOT NULL auto_increment,   store_id varchar(64),   products_id int NOT NULL,   products_quantity int NOT NULL,   tier_price decimal(15,4),   tier_price_1 decimal(15,4),   tier_price_2 decimal(15,4),   tier_price_3 decimal(15,4),   use_percentage_discount int,   custom1 varchar(128),   date_added datetime NOT NULL,   last_modified datetime,   PRIMARY KEY (kk_tier_price_id),   KEY i_prodid_kk_tier_price (products_id),   KEY i_storid_kk_tier_price (store_id) );
...
CREATE TABLE kk_catalog_quantity (   store_id varchar(64),   catalog_id varchar(32) NOT NULL,   products_id int NOT NULL,   products_options varchar(128) NOT NULL,   products_quantity int NOT NULL,   products_date_available datetime,   PRIMARY KEY (catalog_id,products_id, products_options) );
...
CREATE TABLE promotion_to_customer_use (   store_id varchar(64),   promotion_id int NOT NULL,   customers_id int NOT NULL,   times_used int NOT NULL DEFAULT '0',   PRIMARY KEY (promotion_id,customers_id) );
...
CREATE TABLE kk_msg (   msg_key varchar(100) NOT NULL,   msg_locale varchar(10) NOT NULL,   msg_type int NOT NULL,   msg_value text,   PRIMARY KEY (msg_key,msg_type,msg_locale) );
...
CREATE TABLE kk_addr_to_product (   store_id varchar(64),   address_book_id int NOT NULL,   products_id int NOT NULL,   relation_type int NOT NULL DEFAULT 0,   PRIMARY KEY (address_book_id,products_id) );
...
CREATE TABLE kk_cust_attr (    kk_cust_attr_id int NOT NULL auto_increment,    store_id varchar(64),    name varchar(64) NOT NULL,    msg_cat_key varchar(128),    attr_type integer DEFAULT '-1',    template varchar(128),    validation varchar(512),    set_function varchar(512),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    date_added datetime NOT NULL,    PRIMARY KEY (kk_cust_attr_id),    KEY idx_nm_kk_cust_attr (name),    KEY idx_st_id_kk_cust_attr (store_id)    );
DROP TABLE IF EXISTS kk_cust_attr_tmpl;
CREATE TABLE kk_cust_attr_tmpl (    kk_cust_attr_tmpl_id int NOT NULL auto_increment,    store_id varchar(64),    name varchar(64) NOT NULL,    description varchar(255),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    date_added datetime NOT NULL,    PRIMARY KEY (kk_cust_attr_tmpl_id),    KEY idx_nm_kk_cust_attr_tmpl (name),    KEY idx_st_kk_cust_attr_tmpl (store_id)    );
DROP TABLE IF EXISTS kk_tmpl_to_cust_attr;
CREATE TABLE kk_tmpl_to_cust_attr (    kk_cust_attr_tmpl_id int DEFAULT '0' NOT NULL,    kk_cust_attr_id int DEFAULT '0' NOT NULL,    store_id varchar(64),    sort_order int DEFAULT '0' NOT NULL,    PRIMARY KEY (kk_cust_attr_tmpl_id, kk_cust_attr_id),    KEY idx_st_kk_tmpl_to_cust_attr (store_id) );
...
CREATE TABLE kk_cust_stats (    cust_stats_id int NOT NULL auto_increment,    store_id varchar(64),    customers_id int DEFAULT 0,    event_type int DEFAULT 0,    data1Str varchar(128),    data2Str varchar(128),    data1Int int,    data2Int int,    data1Dec decimal(15,4),    data2Dec decimal(15,4),    date_added datetime NOT NULL,    PRIMARY KEY (cust_stats_id)    );
...
CREATE TABLE kk_bookable_prod (    products_id int NOT NULL,    store_id varchar(64),    start_date datetime NOT NULL,    end_date datetime NOT NULL,    max_num_bookings int DEFAULT -1,    bookings_made int DEFAULT 0,    monday varchar(128),    tuesday varchar(128),    wednesday varchar(128),    thursday varchar(128),    friday varchar(128),    saturday varchar(128),    sunday varchar(128),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    custom4 varchar(128),    custom5 varchar(128),    PRIMARY KEY (products_id) );
DROP TABLE IF EXISTS kk_booking;
CREATE TABLE kk_booking (    booking_id int NOT NULL auto_increment,    store_id varchar(64),    products_id int NOT NULL,    quantity int DEFAULT 0,    customers_id int DEFAULT 0,    orders_id int DEFAULT 0,    orders_products_id int DEFAULT 0,    firstname varchar(32),    lastname varchar(32),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    date_added datetime,    PRIMARY KEY (booking_id) );
...
CREATE TABLE kk_catalog (    catalog_id int NOT NULL auto_increment,    store_id varchar(64),    cat_name varchar(32) NOT NULL,    description varchar(255),    use_cat_prices int,    use_cat_quantities int,    PRIMARY KEY (catalog_id) );
...
CREATE TABLE kk_sso (    kk_sso_id int NOT NULL auto_increment,    secret_key varchar(255) NOT NULL,    customers_id int DEFAULT 0,    sesskey varchar(32),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    date_added datetime,    PRIMARY KEY (kk_sso_id),    KEY i_kk_sso_1 (secret_key) );
...
CREATE TABLE kk_misc_item_type (    kk_misc_item_type_id int NOT NULL,    language_id int NOT NULL,    name varchar(128),    description varchar(256),    store_id varchar(64),    date_added datetime,    PRIMARY KEY (kk_misc_item_type_id, language_id) );
DROP TABLE IF EXISTS kk_misc_item;
CREATE TABLE kk_misc_item (    kk_misc_item_id int NOT NULL auto_increment,    kk_obj_id int NOT NULL,    kk_obj_type_id int NOT NULL,    kk_misc_item_type_id int NOT NULL,    item_value varchar(512),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    store_id varchar(64),    date_added datetime,    PRIMARY KEY (kk_misc_item_id) );
...
CREATE TABLE kk_config (    kk_config_id int NOT NULL auto_increment,    kk_config_key varchar(16),    kk_config_value varchar(256),    date_added datetime,    PRIMARY KEY (kk_config_id) );
...
CREATE TABLE kk_product_to_templates (   store_id varchar(64),   products_id int NOT NULL,   cust_attr_tmpl_id int NOT NULL,   sort_order int NOT NULL DEFAULT '0',   PRIMARY KEY (products_id ,cust_attr_tmpl_id) );
...
CREATE TABLE kk_order_refunds (    order_refunds_id int NOT NULL auto_increment,    orders_id int NOT NULL,    ipn_history_id int,    orders_number varchar(128),    refund_note text,    refund_amount decimal(15,4),    gateway_credit_id varchar(64),    notify_customer int DEFAULT 0,    refund_status int DEFAULT 0,    date_added datetime,    last_modified datetime,    store_id varchar(64),    custom1 varchar(128),    custom2 varchar(128),    custom3 varchar(128),    custom1Dec decimal(15,4),    custom2Dec decimal(15,4),    PRIMARY KEY (order_refunds_id) );
...
CREATE TABLE kk_event (    kk_event_id INT NOT NULL auto_increment,    kk_event_code INT NOT NULL,    kk_event_subcode INT,    kk_event_value VARCHAR(64),    store_id VARCHAR(64),    custom1 VARCHAR(64),    date_added DATETIME,    PRIMARY KEY (kk_event_id),    KEY idx_kk_event_date_added (date_added) );
...
CREATE TABLE kk_shipper (    shipper_id INT NOT NULL auto_increment,    name VARCHAR(64) NOT NULL,    tracking_url VARCHAR(255),    date_added datetime,    store_id VARCHAR(64),    custom1 VARCHAR(128),    custom2 VARCHAR(128),    custom3 VARCHAR(128),    PRIMARY KEY (shipper_id) );
...
CREATE TABLE kk_order_shipments (    order_shipment_id int NOT NULL auto_increment,    order_id int NOT NULL,    store_id VARCHAR(64),    order_number VARCHAR(128),    shipper_name VARCHAR(64),    shipper_id int,    tracking_number VARCHAR(64),    tracking_url VARCHAR(255),    custom1 VARCHAR(128),    custom2 VARCHAR(128),    custom3 VARCHAR(128),    shipment_notes text,    date_added datetime,    last_modified datetime,    PRIMARY KEY (order_shipment_id) );
DROP TABLE IF EXISTS kk_shipments_to_ord_prods;
CREATE TABLE kk_shipments_to_ord_prods (    order_shipment_id int NOT NULL,    order_product_id int NOT NULL,    store_id VARCHAR(64),    quantity int NOT NULL,    date_added datetime,    PRIMARY KEY (order_shipment_id, order_product_id) );
...
CREATE TABLE kk_misc_price (   kk_misc_price_id int NOT NULL auto_increment,   store_id varchar(64),   product_id int NOT NULL,   price_id varchar(128) NOT NULL,   price_0 decimal(15,4),   price_1 decimal(15,4),   price_2 decimal(15,4),   price_3 decimal(15,4),   quantity int,   custom1 varchar(256),   custom2 varchar(128),   custom3 varchar(128),   custom4 varchar(128),   custom5 varchar(128),   date_added datetime,   last_updated datetime,   PRIMARY KEY (kk_misc_price_id) );
...
DROP TABLE IF EXISTS orders_status;
CREATE TABLE orders_status (    orders_status_pk int NOT NULL auto_increment,    store_id varchar(64),    orders_status_id int DEFAULT '0' NOT NULL,    language_id int DEFAULT '1' NOT NULL,    orders_status_name varchar(32) NOT NULL,    notify_customer int DEFAULT 0,    PRIMARY KEY (orders_status_pk),    KEY idx_orders_status_name (orders_status_name) );
...
CREATE TABLE kk_cust_pwd_hist (    id INT NOT NULL auto_increment,    cust_id INT NOT NULL,    password VARCHAR(40),    date_created DATETIME,    custom1 VARCHAR(128),    PRIMARY KEY (id),    KEY idx_kk_cust_pwd_hist_cust_id (cust_id) );
...
DELETE FROM configuration WHERE configuration_key = 'STORE_FRONT_SCRIPT_BASE_M';
DELETE FROM configuration WHERE configuration_key = 'STORE_FRONT_STYLE_BASE_M';
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '7.4.0.0 I', now());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '7.4.0.0 MySQL', now());
DROP TABLE IF EXISTS kk_content_type;
CREATE TABLE kk_content_type (    id INT NOT NULL auto_increment,    content_type_id INT DEFAULT 0 NOT NULL,    custom1 VARCHAR(32),    custom2 VARCHAR(32),    date_added DATETIME,    store_id VARCHAR(64),    PRIMARY KEY (id) );
ALTER TABLE kk_content_type ADD KEY idx_content_type_id (content_type_id);
DROP TABLE IF EXISTS kk_content_type_desc;
CREATE TABLE kk_content_type_desc (    id INT NOT NULL auto_increment,    content_type_id INT NOT NULL,    language_id INT NOT NULL,    content_type_name VARCHAR(32),    description VARCHAR(256),    custom1 VARCHAR(32),    custom2 VARCHAR(32),    date_added DATETIME,    store_id VARCHAR(64),    PRIMARY KEY (id) );
ALTER TABLE kk_content_type_desc ADD KEY idx_content_type_id (content_type_id);
DROP TABLE IF EXISTS kk_content;
CREATE TABLE kk_content (    id INT NOT NULL auto_increment,    content_id INT DEFAULT 0 NOT NULL,    content_type_id INT DEFAULT 0 NOT NULL,    object_id INT,    obj_type_id INT,    click_url VARCHAR(256),    date_from DATETIME,    date_to DATETIME,    enabled INT(1) DEFAULT 0 NOT NULL,    expression_id INT DEFAULT 0 NOT NULL,    search_key VARCHAR(128),    custom1 VARCHAR(32),    custom2 VARCHAR(32),    custom3 VARCHAR(32),    custom4 VARCHAR(32),    updated_by INT NOT NULL,    date_updated DATETIME,    date_added DATETIME,    store_id VARCHAR(64),    PRIMARY KEY (id) );
...
CREATE TABLE kk_content_desc (    id INT NOT NULL auto_increment,    content_id INT NOT NULL,    language_id INT NOT NULL,    name1 VARCHAR(256),    name2 VARCHAR(256),    name3 VARCHAR(256),    name4 VARCHAR(256),    title VARCHAR(256),    content MEDIUMTEXT,    custom1 VARCHAR(32),    custom2 VARCHAR(32),    custom3 VARCHAR(32),    custom4 VARCHAR(32),    date_added DATETIME,    store_id VARCHAR(64),    PRIMARY KEY (id) );
...
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 1, 'home_delonghi.jpg', 'home_delonghi-medium.jpg', 'home_delonghi-small.jpg', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 2, 'home_delonghi.jpg', 'home_delonghi-medium.jpg', 'home_delonghi-small.jpg', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 3, 'home_delonghi.jpg', 'home_delonghi-medium.jpg', 'home_delonghi-small.jpg', 'DeLonghi Coffee Maker', now());
INSERT INTO kk_content_desc (content_id, language_id, name1, name2, name3, title, date_added) VALUES (17, 4, 'home_delonghi.jpg', 'home_delonghi-medium.jpg', 'home_delonghi-small.jpg', 'DeLonghi Coffee Maker', now());
