-- SEE INSERTS FOR country AT THE END OF THIS FILE --
...
INSERT INTO `${database}`.`user_status` VALUES(1, 'Unactivated');
INSERT INTO `${database}`.`user_status` VALUES(2, 'Activated');
INSERT INTO `${database}`.`user_status` VALUES(3, 'Deactivated');

  ------------------------------------
  -- Made to conform iso currency code
  ------------------------------------
INSERT INTO `${database}`.`currency` VALUES (566, 'NGN');

INSERT INTO `${database}`.`how_did_you_find_us` VALUES (1, 'Through a friend or colleague');
INSERT INTO `${database}`.`how_did_you_find_us` VALUES (2, 'From the internet/online');
INSERT INTO `${database}`.`how_did_you_find_us` VALUES (3, 'Magazines or other print media');
INSERT INTO `${database}`.`how_did_you_find_us` VALUES (4, 'TV or other electronic media');
INSERT INTO `${database}`.`how_did_you_find_us` VALUES (5, 'Through our agent');

INSERT INTO `${database}`.`productcategory` VALUES (1, 'Fashion');

INSERT INTO `${database}`.`product_subcategory` VALUES (1, 'Women''s Clothes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (2, 'Women''s Shoes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (3, 'Women''s Accessories', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (4, 'Men''s Clothes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (5, 'Men''s Shoes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (6, 'Men''s Accessories', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (7, 'Kid''s Clothes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (8, 'Kid''s Shoes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (9, 'Kid''s Accessories', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (10, 'Baby''s Clothes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (11, 'Baby''s Shoes', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (12, 'Baby''s Accessories', 1);
INSERT INTO `${database}`.`product_subcategory` VALUES (13, 'Other', 1);

INSERT INTO `${database}`.`product_status` VALUES (1, 'New');
INSERT INTO `${database}`.`product_status` VALUES (2, 'Classic');
INSERT INTO `${database}`.`product_status` VALUES (3, 'Refurbished');
INSERT INTO `${database}`.`product_status` VALUES (4, 'Used');
...
INSERT INTO `${database}`.`order_status` VALUES (1, 'Pending');
INSERT INTO `${database}`.`order_status` VALUES (2, 'Ordered, Waiting for Payment');
INSERT INTO `${database}`.`order_status` VALUES (3, 'Ordered, Waiting for Shipping');
INSERT INTO `${database}`.`order_status` VALUES (4, 'Processing Payment');
INSERT INTO `${database}`.`order_status` VALUES (5, 'Payment Received');
INSERT INTO `${database}`.`order_status` VALUES (6, 'Payment Declined');
INSERT INTO `${database}`.`order_status` VALUES (7, 'Fully Dispatched');
INSERT INTO `${database}`.`order_status` VALUES (8, 'Partially Dispatched');
INSERT INTO `${database}`.`order_status` VALUES (9, 'Fully Arrived');
INSERT INTO `${database}`.`order_status` VALUES (10, 'Partially Arrived');
INSERT INTO `${database}`.`order_status` VALUES (11, 'Fully Received');
INSERT INTO `${database}`.`order_status` VALUES (12, 'Partially Received');

INSERT INTO `${database}`.`payment_method` VALUES (1, 'Master Card');
INSERT INTO `${database}`.`payment_method` VALUES (2, 'Visa Card');
INSERT INTO `${database}`.`payment_method` VALUES (3, 'Verve');
INSERT INTO `${database}`.`payment_method` VALUES (4, 'Bank Deposit');
INSERT INTO `${database}`.`payment_method` VALUES (5, 'Cash on Delivery');
INSERT INTO `${database}`.`payment_method` VALUES (6, 'Book on Hold');
--INSERT INTO `${database}`.`payment_method` VALUES (7, 'Pay Pal');
--INSERT INTO `${database}`.`payment_method` VALUES (8, 'Mobile Money');
--INSERT INTO `${database}`.`payment_method` VALUES (9, 'Bitcoin');
